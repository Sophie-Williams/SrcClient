...
class GuildWindow(ui.ScriptWindow):
	...
	def __Initialize(self):
		...
		self.currentMultipler = 1
		self.currentWarMember = 5
		self.currentWarMercenary = 0
	...
	def __MakeInfoPage(self):
		...
		try:
			...
			page.multiplerSlot = page.GetChild("MultiplerValue")
			page.warMemberSlot = page.GetChild("GuildMemberWarValue")
			page.warMercenarySlot = page.GetChild("GuildMercenaryWarValue")
	...
	def SetGuildBonus(self):
		self.tableBonusGuild = {
									0: [0, 0, 0],
									1: [1.6, 0, 0],
									2: [1.6, 0, 0],
									3: [1.6, 0, 0],
		...
		self.currentMultipler = "%.1f" % round(self.tableBonusGuild[guild.GetGuildLevel()][0],2)
		if self.tableBonusGuild[guild.GetGuildLevel()][0] != 0:
			self.enemyGuildNameList[0].SetText("+" + str("%.1f" % round(self.tableBonusGuild[guild.GetGuildLevel()][0]-1.5,2)) + " Moltiplicatore vittoria")
		if self.tableBonusGuild[guild.GetGuildLevel()][1] != 0:
			self.currentWarMember = 5 + self.tableBonusGuild[guild.GetGuildLevel()][1]
			self.enemyGuildNameList[1].SetText(str("+" + str(self.tableBonusGuild[guild.GetGuildLevel()][1]) + " Membri guerra"))
		if self.tableBonusGuild[guild.GetGuildLevel()][2] != 0:
			self.currentWarMercenary = self.tableBonusGuild[guild.GetGuildLevel()][2]
			self.enemyGuildNameList[2].SetText(str("+" + str(self.tableBonusGuild[guild.GetGuildLevel()][2]) + " Mercenari"))
	...
	def RefreshGuildInfoPage(self):
		...
		page.levelAverageSlot.SetText("Attiva")
		...
		self.SetGuildBonus()
		page.multiplerSlot.SetText(str(self.currentMultipler))
		page.warMemberSlot.SetText(str(self.currentWarMember))
		page.warMercenarySlot.SetText(str(self.currentWarMercenary))
