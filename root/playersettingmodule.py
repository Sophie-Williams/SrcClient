...
def __InitData():
	...
	chrmgr.RegisterCacheEffect(chrmgr.EFFECT_LEVELUP_ON_14_FOR_GERMANY, "","season1/effect/paymessage_warning.mse")	#?????? 14??? ( ???????? )
	chrmgr.RegisterCacheEffect(chrmgr.EFFECT_LEVELUP_UNDER_15_FOR_GERMANY, "", "season1/effect/paymessage_decide.mse" )#?????? 15??? ( ???????? )
...
def __LoadGameEffect():
	...
	chrmgr.RegisterEffect(chrmgr.EFFECT_AFFECT+16, "", "d:/ymir work/pc/warrior/effect/gyeokgongjang_loop.mse") ## �???? (????? ???-_-)
	...
	chrmgr.RegisterEffect(chrmgr.EFFECT_AFFECT+28, "Bip01", "d:/ymir work/effect/hit/hwayeom_loop_1.mse")
	...
	chrmgr.RegisterEffect(chrmgr.EFFECT_AFFECT+33, "", "d:/ymir work/pc/warrior/effect/gyeokgongjang_loop.mse") ## �???? (Fallen)
	## 34 Polymoph
	...
	# mate shamy
	chrmgr.RegisterEffect(chrmgr.EFFECT_AFFECT+45, "", "d:/ymir work/monster2/shaman_f_dd/effect/buff1.mse")
	
	chrmgr.RegisterEffect(282, "", "d:/ymir work/effect/etc/new_effect/poison.mse")
	...
	effect.RegisterIndexedFlyData(effect.FLY_HP_BIG, effect.INDEX_FLY_TYPE_NORMAL, "d:/ymir work/effect/etc/gathering/ga_piece_red_big.msf")				## ?????? (HP) u??
	effect.RegisterIndexedFlyData(effect.FLY_SP_SMALL, effect.INDEX_FLY_TYPE_NORMAL, "d:/ymir work/effect/etc/gathering/ga_piece_blue_warrior_small.msf")	## ?K??? ?????? ??�?
	effect.RegisterIndexedFlyData(effect.FLY_SP_MEDIUM, effect.INDEX_FLY_TYPE_NORMAL, "d:/ymir work/effect/etc/gathering/ga_piece_blue_small.msf")			## ?K??? ??????
	effect.RegisterIndexedFlyData(effect.FLY_SP_BIG, effect.INDEX_FLY_TYPE_NORMAL, "d:/ymir work/effect/etc/gathering/ga_piece_blue_big.msf")				## ?K??? u??
	effect.RegisterIndexedFlyData(effect.FLY_POISON_SKILL, effect.INDEX_FLY_TYPE_POISON_BOMB, "d:/ymir work/effect/etc/gathering/ga_piece_green_big.msf")		## ?K??? u??
