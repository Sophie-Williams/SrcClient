...
def __LoadGameEffect():
	...
	effect.RegisterIndexedFlyData(effect.FLY_POISON_SKILL, effect.INDEX_FLY_TYPE_POISON_BOMB, "d:/ymir work/effect/etc/gathering/ga_piece_green_big.msf")		## 파란색 큰거
