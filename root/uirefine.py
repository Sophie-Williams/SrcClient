...
class RefineDialogNew(ui.ScriptWindow):
	...
	def AppendMaterial(self, vnum, count):
		...
		#itemImage.SAFE_SetStringEvent("MOUSE_OVER_IN", self.OverInItem(vnum))
		#itemImage.SetOverOutItemEvent(ui.__mem_func__(self.OverOutItem))
		...
		# self.testToolTip = uiToolTip.ItemToolTip()
		# self.testToolTip.ClearToolTip()
		# self.testToolTip.SetPosition(-200, self.dialogHeight-20)
		# self.testToolTip.AutoAppendTextLine("%s" % item.GetItemName(), self.tooltipItem.TITLE_COLOR)
		# self.testToolTip.AppendSpace(5)
		# self.testToolTip.AutoAppendTextLine("Test value:", self.SPECIAL_POSITIVE_COLOR)			
		# self.testToolTip.SetParent(textLine)
		# self.testToolTip.SetFollow(False)
		# self.testToolTip.ShowToolTip()
