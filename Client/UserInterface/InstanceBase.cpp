...
BOOL CInstanceBase::IsSameEmpire(CInstanceBase& rkInstDst)
{
	...
	if (stringMapName == "metin2_map_t3" || stringMapName == "metin2_map_t4")
		return TRUE;
...
void CInstanceBase::SetAcce(DWORD dwAcce)
{
	...
	if (pItemData->GetItemScale(dwPos, fScaleX, fScaleY, fScaleZ, fPositionX, fPositionY, fPositionZ))
	{
		...
		m_GraphicThingInstance.SetScalePosition(fPositionX, fPositionY, m_kHorse.IsMounting() ? 10.0f + fPositionZ : fPositionZ);
	}
#endif
}
