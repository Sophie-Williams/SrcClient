...
class CPythonNetworkStream : public CNetworkStream, public CSingleton<CPythonNetworkStream>
{
	...
	public:
		...
		// survey
		bool RecvSurveyPacket();
		// biologist
		bool RecvBiologistPacket();
		bool RecvMercenaryPacket();
		bool RecvMercenaryEquipPacket();
		bool RecvMercenaryWarLogPacket();

		bool RecvGQuestPacket();
#ifdef ENABLE_AUTO_PVP_SYSTEM
		bool RecvAutoPvpPacket();
#endif
		// Dig
