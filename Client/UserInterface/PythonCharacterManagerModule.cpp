...
void initchrmgr()
{
	...
	PyModule_AddIntConstant(poModule, "EFFECT_STATICK1", CInstanceBase::EFFECT_STATICK1);
	PyModule_AddIntConstant(poModule, "EFFECT_STATICK2", CInstanceBase::EFFECT_STATICK2);
	PyModule_AddIntConstant(poModule, "EFFECT_STATICK3", CInstanceBase::EFFECT_STATICK3);

	PyModule_AddIntConstant(poModule, "EFFECT_POISON_BOMB", CInstanceBase::EFFECT_POISON_BOMB);
}
