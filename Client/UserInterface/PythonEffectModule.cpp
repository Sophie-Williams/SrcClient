...
void initeffect()
{
	...
	PyModule_AddIntConstant(poModule, "INDEX_FLY_TYPE_POISON_BOMB",		CFlyingManager::INDEX_FLY_TYPE_POISON_BOMB);
	...
	PyModule_AddIntConstant(poModule, "FLY_POISON_SKILL", FLY_POISON_SKILL);
}
