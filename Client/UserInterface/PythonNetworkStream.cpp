...
class CMainPacketHeaderMap : public CNetworkPacketHeaderMap
{
	...
	public:
		CMainPacketHeaderMap()
		{
			...
			Set(HEADER_GC_SURVEY, CNetworkPacketHeaderMap::TPacketType(sizeof(TPacketSurvey), STATIC_SIZE_PACKET));
			Set(HEADER_GC_BIOLOGIST, CNetworkPacketHeaderMap::TPacketType(sizeof(TPacketBiologist), STATIC_SIZE_PACKET));
			Set(HEADER_GC_MERCENARY, CNetworkPacketHeaderMap::TPacketType(sizeof(TPacketMercenaryList), STATIC_SIZE_PACKET));
			Set(HEADER_GC_MERCENARY_EQUIP, CNetworkPacketHeaderMap::TPacketType(sizeof(TPacketMercenaryEquip), STATIC_SIZE_PACKET));
			Set(HEADER_GC_MERCENARY_WARLOG, CNetworkPacketHeaderMap::TPacketType(sizeof(TPacketMercenaryWarLog), STATIC_SIZE_PACKET));

#ifdef ENABLE_AUTO_PVP_SYSTEM
			Set(HEADER_GC_AUTO_PVP, CNetworkPacketHeaderMap::TPacketType(sizeof(TPacketAutoPvPState), STATIC_SIZE_PACKET));
#endif

			Set(HEADER_GC_QUEST_GUI, CNetworkPacketHeaderMap::TPacketType(sizeof(TGuiQuest), STATIC_SIZE_PACKET));
